...
minetest.register_craft({
	...
	recipe = {
		{'','toolsredo:sword_ruby',''},
		{'toolsredo:sword_amethyst', 'default:diamondblock', 'toolsredo:sword_emerald'},
		{'', 'toolsredo:sword_sapphire', ''}
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'', 'default:diamond', ''},
		{'default:gold_ingot', 'toolsredo:sword_rainbow', 'default:steel_ingot'},
